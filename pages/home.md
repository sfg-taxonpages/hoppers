...
<tr><td colspan="6" style="text-align: center">Valid Species: <ValidSpeciesCount/>; Fossil Species: <FossilSpeciesCount/>; <ProjectStats :data="['Taxon names', 'Collection objects', 'Project sources', 'Documents', 'Citations', 'Images']" class="capitalize"/></td></tr>
</table>
</div>
