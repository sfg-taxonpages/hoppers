...
<tr><td colspan="6" style="text-align: center">Valid Species: <ValidSpeciesCount/>; <ProjectStats :data="['Taxon names', 'Collection objects', 'Project sources', 'Citations', 'Documents', 'Images']" class="capitalize"/></td></tr>
</table>
</div>
