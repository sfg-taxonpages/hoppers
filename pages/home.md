...
<tr><td colspan="6" style="text-align: center">Valid Species in Auchenorrhyncha: <ValidSpeciesCount/>; <ProjectStats :data="['Taxon names', 'Collection objects', 'Project sources', 'Documents', 'Images']" class="capitalize"/></td></tr>
</table>
</div>
